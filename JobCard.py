...
class JobDetailsItem:
    def __init__(self, element):
        self.insight_text = element.text
...
class JobCard:
    ...
    def parseAttributes(self):
        ...
        company_link = job_card.find_element(By.XPATH, """//span[@class = "jobs-unified-top-card__company-name"]/a """)
        self.company_name = company_link.text
        self.company_href = company_link.get_attribute("href")

        self.job_details_items = [JobDetailsItem(elem)
                                  for elem in job_card.find_elements(By.XPATH,
                                                                     """//li[@class="jobs-unified-top-card__job-insight"]/span""")]
